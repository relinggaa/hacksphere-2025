...
return new class extends Migration
{
    ...
    {
        return '2025_10_02_212217_create_tiket_lrt_table';
    }
    ...
    {
        Schema::create('tiket_lrt', function (Blueprint $table) {
            $table->id();
            $table->string('nama_kereta'); // Nama kereta LRT dari dropdown
            $table->string('harga_termurah'); // Harga termurah LRT (sesuai schema string)
